...
npx ts-node -r dotenv/config ./performance/setup/env.ts &&
k6 run -e AAP_CLIENT_ID="$CLIENT_ID" -e AAP_CLIENT_SECRET="$CLIENT_SECRET" -e TOKEN_URL="https://sign-in-dev.hmpps.service.justice.gov.uk/auth/oauth/token" ./performance/tests/aapApi-smoke.js
