...
test.beforeEach(async ({ page }) => {
  ...
  await trainingLauncher.customiseScenario('F286273', '6019199');
...
test(
  'should view sentence plan previous version as private beta user',
  {
    tag: '@test',
  },
  async ({ page }) => {
...
test(
  'should view Strengths and Needs previous version as private beta user',
  {
    tag: '@test',
  },
  async ({ page }) => {
